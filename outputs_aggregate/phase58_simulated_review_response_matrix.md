...
|---|---|---|
| Verify Zenodo/GitHub links | GitHub public page checked; DOI resolved by HTTP request to Zenodo record `20589522` | `manuscript/bmc_womens_health_submission_upload_20260608_phase58/README_UPLOAD.md` |
